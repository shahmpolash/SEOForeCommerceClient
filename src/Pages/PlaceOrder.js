...
const PlaceOrder = () => {
  ...
  useEffect(() => {
    fetch(`https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/cash-on-delivery`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/payment-accounts`)
      .then((res) => res.json())
  ...
  const handlePlaceOrderCashOnDelivery = (event) => {
    ...
    const url = `https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/new-order-cash-on-delivery`;
    fetch(url, {
      method: "POST",
      headers: {
        "content-type": "application/json",
