...
const PaymentStatus = () => {
    ...
    useEffect(() => {
        fetch(`https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/order/${id}`)
            .then((res) => res.json())
    ...
    const handlePaymentStatus = (event) => {
        ...
        const url = `https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/order/${order._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
    ...
    const handleOrderStatus = (event) => {
        ...
        const url = `https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/order-status/${order._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                "content-type": "application/json",
