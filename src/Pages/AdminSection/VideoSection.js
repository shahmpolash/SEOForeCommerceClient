...
const VideoSection = () => {
    ...
    useEffect(() => {
        fetch(`https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/videos`)
            .then((res) => res.json())
            .then((info) => setVideo(info));
    }, []);

    useEffect(() => {
        fetch(`https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/videos-items`)
            .then((res) => res.json())
    ...
    const handleVideoSection = (event) => {
        ...
        const url = `https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/add-video`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/add-video-item`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
