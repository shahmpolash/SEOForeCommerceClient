...
const AddTestimonial = () => {
    ...
    const handleTestimonialSection = (event) => {
        ...
        const url = `https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/add-testimonial-text`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleStepSection = (event) => {
        ...
        const url = `https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/add-testimonial`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
