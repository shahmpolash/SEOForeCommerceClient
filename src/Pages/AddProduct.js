...
const AddProduct = () => {
  ...
  useEffect(() => {
    fetch(`https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/products-variation`)
      .then((res) => res.json())
      .then((info) => setVariations(info));
  }, []);
  useEffect(() => {
    fetch(`https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/categories`)
      .then((res) => res.json())
  ...
  const handleAddProduct = (event) => {
    ...
    const url = `https://ecommerceseonew-99d8d5c72bb6.herokuapp.com/add-product`;
    fetch(url, {
      method: "POST",
      headers: {
